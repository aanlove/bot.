...
cl = LineClient("yukiiaanlove@gmail.com","mahadewi68") 
...
poll = LinePoll(cl)
call = cl
creator = ["u86e289099085904765c3e4b0d77f1469"]
owner = ["ua80d758a710accdb6cfd4bf9bb1b117c"]
admin = ["u86e289099085904765c3e4b0d77f1469"]
staff = ["u86e289099085904765c3e4b0d77f1469"]
...
def help1():
    ...
    helpMessage1 = "❂͜͡➣ " + key + " [TERX BOTS]\n" + \
                  ...
                  "🔑❂͜͡➣ " + key + "sᴘᴀᴍᴄᴀʟʟ:「ᴊᴜᴍʟᴀʜɴʏᴀ」\n" + \
                   ...
                   "「🔑]   ʙʏ: Tn_thebots] \n" + \
                   "  Creator:  line.me/ti/p/~black_ghosst."
...
def help2():
    ...
    helpMessage2= "      「✭SETTING  BOTS-TETX✭」\n" + \
                  ...
                  " [🔑TERX-BOTS\n" + \
                  "🔑Creator:  line.me/ti/p/~gblack_ghost."
...
def help3():
    ...
    helpMessage3 = "      「✭MUSIK ✭」\n" + \
                  ...
                  "「🔑」BY: aan_thebots" + \
                  "  Creator:  line.me/ti/p/~black_ghost."
    ...
    try:
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  cl.sendContact(op.param1, "u86e289099085904765c3e4b0d77f1469")
                 ...
                 if text is None:
                     return
                        ...
                        if cmd == "self on":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                cl.sendText(msg.to, "hadir bos bot urep")
                                
                        elif cmd == "self off":
                            if msg._from in admin:
                                wait["selfbot"] = False
                                cl.sendText(msg.to, "siap aku klon  neh bos")
...
#===========BOT UPDATE============#
                        elif msg.text in ["Cipok","Tagall","Tag","Keluar","metu ","Pagi","Siang","Sore","Malam","Nah","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.sendText(msg.to, "aku pamet rien nggeh bos "+str(G.name))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  cl.sendMessage(msg.to, "「 Status Scctv 」\nBerhasil diaktifkan\n\n• Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]"+"\n• Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d'))
...
"SADIS_BOTS_KILER\n"
		...
		"╚╩╝╚╝╚╝━╚╝━╚╝╚╝\n"
		"━━━━━━━━━━━━━━━\n"
">>>BYE...BYE JANGAN NANGIS>><\nLO DENDAM CARI KAMI\n<<<<<<<<<>>\nhttp://line.me/ti/p/~black_ghost_killer\nhttp://line.me/ti/p/~black_ghost.")
